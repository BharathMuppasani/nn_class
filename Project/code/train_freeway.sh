...
# Usage: ./train_freeway.sh [OPTIONS] [variants...]
# Examples:
#   ./train_freeway.sh                              # Train all 5 variants with defaults
#   ./train_freeway.sh dqn ddqn                     # Train only DQN and Double DQN
#   ./train_freeway.sh --episodes 2000 ddqn_duel    # Train with custom episodes
#   ./train_freeway.sh --lr 1e-4 --epsilon-decay 0.999  # Custom hyperparams for all
...
while [[ $# -gt 0 ]]; do
    case $1 in
        ...
        --help|-h)
            echo "Usage: ./train_freeway.sh [OPTIONS] [variants...]"
            echo ""
            echo "Options:"
