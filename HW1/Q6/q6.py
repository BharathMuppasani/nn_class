...
# import all function from Signal py file
...
''' 
This function demonstrates the use of a reservoir observer to reconstruct the 
Rossler attractor. The system is trained using a short Rossler signal, then tested 
on an extended signal. The observer's predicted states are compared with the 
actual states, and the results are visualized with three subplots showing the 
actual and predicted states over time.
'''
...
''' 
This function shows how a reservoir observer can reconstruct the Lorenz attractor. 
The observer is trained on a set of known Lorenz system states and tested over a 
new signal. The actual and predicted system states are plotted and compared 
through three subplots to demonstrate how well the observer tracks the chaotic 
